...
import { Contact, CreateContactData, UpdateContactData, isValidEmail, isValidPhone, formatPhone } from '@/lib/api/contacts'
...
export default function ContactDialog({ open, onOpenChange, contact, mode }: ContactDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === 'create') {
        await addContact(contactData as CreateContactData)
      } else if (contact) {
        await editContact(contact.id, contactData as UpdateContactData)
      }
